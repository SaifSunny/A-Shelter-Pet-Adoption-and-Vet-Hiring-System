              ...
              <div class="card-body text-center" style="padding:0 60px;">
                <table class="table" style="font-size: 14px;">
                  ...
                  <tbody>
                    ...
                    ?>
                    <tr>
                      <td><img src="./assets/img/doctors/<?php echo $vet_image ?>"
                          style="width:80px;border-radius: 20%;" alt="profile"> <span style="padding-left:20px;"></span>
                      </td>
                      ...
                      <td><a href="user_vet_ratings.php?id=<?php echo $appointment_id ?>"
                          style="border-radius:50%;padding:2px 4px;color:white;" class="btn btn-warning"><i
                            class="fa fa-star"></i></a>
                      </td>
                      <td><a href="user_delete_appointment.php?id=<?php echo $appointment_id ?>"
