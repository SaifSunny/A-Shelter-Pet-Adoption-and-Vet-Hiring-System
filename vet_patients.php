        ...
        <div class="row" style="padding-top:30px;">
          <div class="col-md-12">
            <div class="card mx-auto"
              ...
              <h5 class="card-title" style="padding-top:20px ;">Appointment History</h5>
              <div class="card-body" style="padding:20px 40px; text-align:left;font-size:18px;">
                <table class="table">
                  ...
                  <tbody>
                    <?php 
                       $sql = "SELECT DISTINCT * FROM vet_appointment WHERE vet_id = '$vet_id' AND status = '2' ORDER BY `date` DESC LIMIT 6";
                       $result = mysqli_query($conn, $sql);
                        if($result){
                    ...
                    <tr>
                      ...
                      <td style="font-size:14px; color:black; font-weight:600; "><?php echo $email?></td>
