        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card mx-auto"
              ...
              <h4 style="padding:30px;">Shelter requests</h4>
              <div class="card-body text-center" style="padding:0 60px;">
                <table class="table" style="font-size: 14px;">
                  ...
                  <tbody>
                    <?php 
                      ...
                      if($result){
                        while($row=mysqli_fetch_assoc($result)){
                          ...
                          $shelter_image=$row['shelter_image'];
                    ...
                    ?>
                    <tr>
                    <td><img src="./assets/img/shelters/<?php echo $shelter_image ?>" style="width:80px;border-radius: 20%;"
